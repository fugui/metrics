...
public class MetricRegistry implements MetricSet {
    ...
    public void registerAll(MetricSet metrics) throws IllegalArgumentException {
        delegate.registerAll(metrics.transform());
    }
    ...
    public SortedSet<String> getNames() {
        ...
        for (MetricName name : delegate.getNames()) {
    ...
    public static <T extends Metric> SortedMap<String, T> adaptMetrics(
    ...
    public interface MetricSupplier<T extends Metric> {
        ...
        @SuppressWarnings("unchecked")
        default <M extends io.dropwizard.metrics5.Metric> io.dropwizard.metrics5.MetricRegistry.MetricSupplier<M> transform() {
